...
\section{Experiencia}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
		{Banco Alfin}{Lima, Perú}
		{Especialista de Core Bancario}{Enero 2025 \textbf{--} Actualidad, Full-time, Remoto}
		\resumeItemListStart
		\resumeItem{Desarrollo de reportes de cronogramas para flujos de créditos y reportes de garantías asociadas a los mismos, de acuerdo a los productos activos en el sistema bancario.}
		\resumeItem{Mantenimiento y creación del módulo independiente de líneas revolventes para personas jurídicas. Realizando la creación, bloqueo, cancelación por vencimiento y cancelación manual de líneas además de la generación de créditos a partir del saldo de la línea.}
		\resumeItem{Mejora de la generación de cronogramas personalizado de la institución, agregando funcionalidades como Cuota Balloon, Periodo de gracia, sistema de amortización Francés y Alemán.}
		\resumeItemListEnd
		
    \resumeSubheading
		{SES}{Lima, Perú}
		{Ingeniero de Software}{Enero 2024 \textbf{--} Diciembre 2024, Full-time, Remoto}
		\resumeItemListStart
...
\section{Premios \& Logros}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Bantotal document:}{ Tercer lugar en la competencia "Hackaton Bantotal" con el aplicativo Bantotal Document para la documentación automática de programas escritos en Genexus.} \\ \vspace{3pt}
    }}
  \resumeSubHeadingListEnd
